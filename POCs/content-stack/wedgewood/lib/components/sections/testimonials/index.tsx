  ...
  return (
    ...
    >
      <div>
        <div className={styles.testimonialCardHeader}>
          ...
          <VStack
            alignItems="start"
            spacing="1"
            className={styles.testimonialCardTitleHolder}
          >
            <Text fontWeight="bold" className={styles.testimonialCardTitleName}>
              {authorName}
            </Text>
            <Text fontSize="sm" className={styles.testimonialCardTitleDesc}>
              {authorDescription}
            </Text>
          </VStack>
        </div>
      ...
      <div className={styles.testimonialCardFooter}>
        ...
        <Text fontSize="sm" className={styles.testimonialCardFooterText}>
          {location}
        </Text>
      </div>
    </Box>
    ...
    >
      <VStack align="start">
        <Box px={10} className={styles.testimonialsSectionTitle}>
          ...
          <Text
            textAlign="left"
            className={styles.testimonialsSectionDescription}
          >
